...
#line hidden
            ...
            else
            {
                ...
                table3.AddRow(new string[] {
                            ...
                            "invalid-email"});
#line 5
    await testRunner.GivenAsync("I have an invalid create admin request", ((string)(null)), table3, "Given ");
#line hidden
#line 10
...
#line hidden
                ...
                table4.AddRow(new string[] {
                            ...
                            "Admin"});
#line 11
    await testRunner.ThenAsync("the admin profile creation fails with a validation error", ((string)(null)), table4, "Then ");
#line hidden
            }
