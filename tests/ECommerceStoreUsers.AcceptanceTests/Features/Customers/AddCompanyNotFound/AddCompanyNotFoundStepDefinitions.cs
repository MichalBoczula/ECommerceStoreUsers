...
namespace ECommerceStoreUsers.AcceptanceTests.Features.Customers.AddCompanyNotFound
{
    ...
    public class AddCompanyNotFoundStepDefinitions
    {
        ...
        public void GivenIHaveAMissingCustomerAddCompanyRequest(Table table)
        {
            ...
            AllureJson.AttachObject(
                "Missing customer add company request contract",
                _request,
                _apiContext.JsonOptions);
        }

        [When("I submit the missing customer add company request")]
        public async Task WhenISubmitTheMissingCustomerAddCompanyRequest()
        {
        ...
        public async Task ThenTheAddCompanyRequestFailsWithANotFoundResponse(Table table)
        {
            ...
            AllureJson.AttachObject("Expected add company not found result table", expected, _apiContext.JsonOptions);
